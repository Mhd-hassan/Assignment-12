...
def function1(): # Defining a Function 1 in Module 4
    print("This is Function 1  in Module 4")

def function2(): # Defining a Function 2 in Module 4
    print("This is Function 2 in Module 4")
